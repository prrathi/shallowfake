...
class WhisperASR(AdvASRBrain):
    ...
    def compute_forward(self, batch, stage):
        ...
        if stage != sb.Stage.TRAIN and stage != rs.Stage.ATTACK:
            ...
            with torch.no_grad():
                ...
                text = result["text"]
                pred_tokens = torch.LongTensor([self.tokenizer.encode(text, disallowed_special=())])
    ...
    def compute_objectives(
        self, predictions, batch, stage, adv=False, targeted=False, reduction="mean", stoi=None
    ):
            ...
            if adv:
                if targeted:
                    ...
                    self.adv_wer_metric.append(
                        ids, predicted_words, target_words, stois = [stoi])
